...
Filesystem.tempDir = function ( cb ) {
	var root = new Filesystem ( Filesystem.tmp || os.tmpdir() );
	root.tempDir( cb );
}
...
Filesystem.prototype.tempDir = function ( cb )
{
	var
		filesystem = this,
		nameLength = 16,
...
Filesystem.setDefaultTempDir = function ( path ) {
